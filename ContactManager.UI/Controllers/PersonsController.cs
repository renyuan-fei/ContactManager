using ContactManager.UI.Filters;
using ContactManager.UI.Filters.ActionFilters;
using ContactManager.UI.Filters.AuthorizationFilters;
using ContactManager.UI.Filters.ResourcesFilters;
...
namespace ContactManager.UI.Controllers
{
  ...
  public class PersonsController : Controller
  {
    ...
    // [ TypeFilter(typeof(ResponseHeaderActionFilter),
    //              Arguments =
    //                  new object[ ] { "MyKey-FromAction", "MyValue-From-Action", 1 },
    //              Order = 1) ]
    ...
    [ HttpGet ]
    // [ TypeFilter(typeof(ResponseHeaderActionFilter),
    //              Arguments = new object[ ] { "my-key", "my-value", 4 }) ]
    ...
    [ TypeFilter(typeof(PersonCreateAndEditPostActionFilter)) ]
    [ TypeFilter(typeof(TokenAuthorizationFilter), Arguments = new object[ ] { 0 }) ]
    ...
    {
      PersonResponse? personResponse =
          await _personsGetterService.GetPersonByPersonID(personUpdateResult.PersonID);
    ...
    public async Task<IActionResult> PersonsPDF()
    {
      ...
      {
          PageMargins =
              new Rotativa.AspNetCore.Options.Margins()
              {
