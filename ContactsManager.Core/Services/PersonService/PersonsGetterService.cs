...
namespace ContactsManager.Core.Services.PersonService
{
 public class PersonsGetterService : IPersonsGetterService
 {
  ...
  public async virtual Task<List<PersonResponse>> GetAllPersons()
  {
  ...
  public async virtual Task<PersonResponse?> GetPersonByPersonID(Guid? personID)
  {
   if (personID == null)
    return null;
  ...
  public async virtual Task<List<PersonResponse>> GetFilteredPersons(string searchBy, string? searchString)
  {
  ...
  public async virtual Task<MemoryStream> GetPersonsCSV()
  {
  ...
  public async virtual Task<MemoryStream> GetPersonsExcel()
  {
